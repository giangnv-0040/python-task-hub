...
Revision ID: 85bffc463af4
Revises: 
Create Date: 2026-09-24 11:18:17.621220
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ADMIN', 'PM', 'MEMBER', name='user_role'), nullable=False),
